# 📺 Stremio Hisense TVOS (v1.10.0) — Self-hosted Edition

> This is a forked **dump of the Stremio Hisense v1.10.0 TVOS web app**. I do not claim ownership of the original code.  
...
This repo contains a **static copy of the Stremio Hisense web app** (version 1.10.0) used on Vidaa-based Smart TVs.  
...
App Source: https://wn7lso8ghdka.stremio.com/hisense/1.10.0/index.html
